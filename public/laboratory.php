...
?>
        ...
        <div class="panel" id="samplesPanel" style="display:none;">
            ...
            <form id="sampleForm" class="field-row" style="align-items:flex-end;">
                ...
                <div class="field"><label>Tipo de examen</label><select id="sam_tipo_examen_id" required></select></div>
        ...
        <div class="modal-overlay" id="resultModal">
            <div class="modal">
                ...
                <form id="resultForm">
                    ...
                    <div class="field"><label>Parámetro</label><select id="res_parametro_id" required></select></div>
